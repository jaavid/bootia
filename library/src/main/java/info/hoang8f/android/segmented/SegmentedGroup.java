...
public class SegmentedGroup extends RadioGroup {
    ...
    private void updateBackground(View view) {
        ...
        ColorStateList colorStateList = new ColorStateList(new int[][]{
                ...
                {android.R.attr.state_checked}},
                new int[]{mCheckedTextColor, mUnCheckedTintColor});
        ...
        ((GradientDrawable) checkedDrawable).setStroke(mMarginDp,getResources().getColor(R.color.gray_border) );
        ((GradientDrawable) uncheckedDrawable).setStroke(mMarginDp, getResources().getColor(R.color.gray_border));
        ...
        maskDrawable.setStroke(mMarginDp, getResources().getColor(R.color.gray_border));
        ...
        super.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(current != null)current.reverseTransition(200);
                if (mLastCheckId != 0) {
